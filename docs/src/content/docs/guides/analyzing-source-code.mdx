---
title: Analyzing the Obsidian source code
description: Learn how to analyze the minified source code of Obsidian to understand the behavior of undocumented functions.
---
